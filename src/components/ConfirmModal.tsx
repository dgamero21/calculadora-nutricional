...
export function ConfirmModal({
    ...
    return (
        <div className="fixed inset-0 bg-stone-900/50 backdrop-blur-sm z-[100] flex items-center justify-center p-4 animate-in fade-in transition-all">
            <div className="bg-white rounded-2xl p-6 w-full max-w-sm shadow-2xl animate-in zoom-in-95 pointer-events-auto">
                ...
                <div className="flex justify-end gap-2">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="px-6 py-2.5 bg-red-600 text-white rounded-xl hover:bg-red-700 active:scale-95 font-semibold transition-all disabled:opacity-50 shadow-lg shadow-red-200 cursor-pointer"
                    >
